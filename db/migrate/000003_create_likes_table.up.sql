CREATE TABLE likes(
  sent_user_uid VARCHAR(255) NOT NULL,
	recived_user_uid VARCHAR(255) NOT NULL,
  ...
  KEY `index_likes_on_recived_user_uid` (`recived_user_uid`),
  UNIQUE INDEX (`sent_user_uid`, `recived_user_uid`),
  CONSTRAINT `index_likes_on_sent_user_uid` FOREIGN KEY (`sent_user_uid`) REFERENCES `users` (`uid`),
  CONSTRAINT `index_likes_on_recived_user_uid` FOREIGN KEY (`recived_user_uid`) REFERENCES `users` (`uid`)
